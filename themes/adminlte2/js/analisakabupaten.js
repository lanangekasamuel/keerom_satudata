...
function loadAnalisaChart(id){
    ...
    $.get(PUSDAHOST+'ajax/analisakabupaten/chart_analisa/'+id+'?'+tahun_chart,{'ajaxOn':1})
...
$.get( PUSDAHOST+'files/kelompok-complete.json', function (data) 
      {});
       ...
       $('.kelompok').autocomplete(
       {
            ...
            $.post(PUSDAHOST+'ajax/analisakabupaten/listkelompok_analisa/1?keyword='+request.term)
                .success(function(data) { 
